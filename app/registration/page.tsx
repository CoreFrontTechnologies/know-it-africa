...
const highlights = [
  ...
  { label: "Payment connection coming next", icon: CreditCard },
];

export const metadata = {
  title: "Register for the AI & Software Development Bootcamp | Know It Africa",
  description:
    "Register interest for Know It Africa's AI & Software Development Bootcamp. Phase 2 includes validated form collection before payment integration is added.",
};
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_0.82fr] lg:items-end">
              <div>
                ...
                <p className="mt-6 max-w-3xl text-lg leading-8 text-white/76">
                  Complete the form below so Know It Africa can capture learner details, understand the best class fit, and prepare for payment confirmation in the next phase.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-8 rounded-[2rem] border border-royal/8 bg-white p-5 shadow-luxury sm:p-7">
              <div className="grid gap-4 md:grid-cols-[1fr_auto] md:items-center">
                <div>
                  <p className="text-sm font-black uppercase tracking-[0.18em] text-primary-blue">Phase 2 Form Preview</p>
                  ...
                  <p className="mt-2 text-sm leading-7 text-muted-text">
                    All required fields are validated with friendly messages. Submitting validates the form only; Supabase saving and Flutterwave payment are not connected yet.
                  </p>
                </div>
